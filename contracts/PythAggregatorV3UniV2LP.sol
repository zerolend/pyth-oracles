...
contract PythAggregatorV3UniV2LP {
    ...
    function tokenAPrice() public view returns (uint256) {
        return _getPythResponse256(priceIdA);
    }

    function tokenBPrice() public view returns (uint256) {
        return _getPythResponse256(priceIdB);
    }
