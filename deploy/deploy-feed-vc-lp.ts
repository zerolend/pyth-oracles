...
export default async function (hre: HardhatRuntimeEnvironment) {
  ...
  const artifact = await deployer.loadArtifact("PythAggregatorV3VCStableLP");
  ...
  if (process.env.NODE_ENV != "test") {
    ...
    const contractFullyQualifedName =
      "contracts/PythAggregatorV3VCStableLP.sol:PythAggregatorV3VCStableLP";
